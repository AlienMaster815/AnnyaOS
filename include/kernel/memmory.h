...
#define KERNEL_WRITE_COMBINE_MEMORY WRITE_THROUGH_PAGE | WRITEABLE_PAGE | PRESENT_PAGE
#define USER_GENERIC_MEMORY         USER_PAGE | WRITEABLE_PAGE | PRESENT_PAGE
#define USER_READ_ONLY_MEMORY       USER_PAGE | PRESENT_PAGE
#define USER_DMA_MEMORY             UNCACHEABLE_PAGE | USER_PAGE | WRITEABLE_PAGE |PRESENT_PAGE
#define USER_WRITE_COMBINE_MEMORY   WRITE_THROUGH_PAGE | USER_PAGE | WRITEABLE_PAGE | PRESENT_PAGE
