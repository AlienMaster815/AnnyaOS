...
#define STATUS_OPLOCK_BREAKPROGRESS  ((NTSTATUS)0x00000108L)
...
#define STATUS_DS_MEMBERSHIP_BUILD_CHILDREND_LOCALLY ((NTSTATUS)0x00000121L)
#define STATUS_NOTHING_TO_TERMINATE      ((NTSTATUS)0x00000122L)
#define STATUS_PROCESS_NOTJOB        ((NTSTATUS)0x00000123L)
#define STATUS_PROCESSJOB            ((NTSTATUS)0x00000124L)
...
#define STATUS_DEVICE_SUPPORTPROGRESS ((NTSTATUS)0x80000030L)
...
#define STATUS_GRAPHICS_LINK_CONFIGURATIONPROGRESS ((NTSTATUS)0x801E0000L)
...
#define STATUS_PAGE_ERROR                ((NTSTATUS)0xC0000006L)    // winnt
...
#define STATUS_NO_MEDIADEVICE            ((NTSTATUS)0xC0000013L)
...
#define STATUS_MEMBERGROUP           ((NTSTATUS)0xC0000067L)
#define STATUS_MEMBER_NOTGROUP       ((NTSTATUS)0xC0000068L)
...
#define STATUS_CONNECTIONUSE         ((NTSTATUS)0xC0000108L)
...
#define STATUS_THREAD_NOTPROCESS     ((NTSTATUS)0xC000012AL)
#define STATUS_TOKEN_ALREADYUSE      ((NTSTATUS)0xC000012BL)
...
#define STATUS_MEMBER_NOTALIAS       ((NTSTATUS)0xC0000152L)
#define STATUS_MEMBERALIAS           ((NTSTATUS)0xC0000153L)
...
#define STATUS_FILE_METADATA_OPTIMIZATIONPROGRESS ((NTSTATUS)0xC00001ABL)
#define STATUS_NOT_SAME_OBJECT           ((NTSTATUS)0xC00001ACL)
#define STATUS_FATAL_MEMORY_EXHAUSTION   ((NTSTATUS)0xC00001ADL)
#define STATUS_ERROR_PROCESS_NOTJOB  ((NTSTATUS)0xC00001AEL)
...
#define STATUS_FOUNDOF_SCOPE        ((NTSTATUS)0xC000022EL)
...
#define STATUS_POLICY_ONLYDS         ((NTSTATUS)0xC000029BL)
...
#define STATUS_JOURNAL_DELETEPROGRESS ((NTSTATUS)0xC00002B7L)
...
#define STATUS_DS_NO_NEST_GLOBALGROUPMIXEDDOMAIN ((NTSTATUS)0xC00002D5L)
#define STATUS_DS_NO_NEST_LOCALGROUPMIXEDDOMAIN ((NTSTATUS)0xC00002D6L)
...
#define STATUS_DS_NO_FPOUNIVERSAL_GROUPS ((NTSTATUS)0xC00002E6L)
...
#define STATUS_SHUTDOWNPROGRESS      ((NTSTATUS)0xC00002FEL)
#define STATUS_SERVER_SHUTDOWNPROGRESS ((NTSTATUS)0xC00002FFL)
...
#define STATUS_DS_SRC_SID_EXISTSFOREST ((NTSTATUS)0xC0000419L)
#define STATUS_DS_DOMAIN_NAME_EXISTSFOREST ((NTSTATUS)0xC000041AL)
#define STATUS_DS_FLAT_NAME_EXISTSFOREST ((NTSTATUS)0xC000041BL)
...
#define STATUS_REQUESTOF_SEQUENCE   ((NTSTATUS)0xC000042AL)
...
#define STATUS_ENCOUNTERED_WRITEPROGRESS ((NTSTATUS)0xC0000433L)
...
#define STATUS_THREAD_ALREADYSESSION ((NTSTATUS)0xC0000456L)
#define STATUS_THREAD_NOTSESSION     ((NTSTATUS)0xC0000457L)
...
#define STATUS_INVALID_FIELDPARAMETER_LIST ((NTSTATUS)0xC0000475L)
#define STATUS_OPERATIONPROGRESS     ((NTSTATUS)0xC0000476L)
...
#define STATUS_DEVICEMAINTENANCE     ((NTSTATUS)0xC0000499L)
...
#define STATUS_CASE_DIFFERING_NAMESDIR ((NTSTATUS)0xC00004B3L)
...
#define STATUS_INDEXOF_BOUNDS       ((NTSTATUS)0xC00004D1L)
...
#define STATUS_THREAD_ALREADYTASK    ((NTSTATUS)0xC0000502L)
...
#define STATUS_RESOURCEUSE           ((NTSTATUS)0xC0000708L)
...
#define STATUS_DS_DOMAIN_RENAMEPROGRESS ((NTSTATUS)0xC0000801L)
...
#define STATUS_PROACTIVE_SCANPROGRESS ((NTSTATUS)0xC000080FL)
...
#define STATUS_RUNLEVEL_SWITCHPROGRESS ((NTSTATUS)0xC000A146L)
#define STATUS_NOT_APPCONTAINER          ((NTSTATUS)0xC000A200L)
#define STATUS_NOT_SUPPORTEDAPPCONTAINER ((NTSTATUS)0xC000A201L)
...
#define STATUS_CLOUD_FILE_NOTSYNC    ((NTSTATUS)0xC000CF08L)
...
#define STATUS_CLOUD_FILEUSE         ((NTSTATUS)0xC000CF14L)
...
#define STATUS_FILE_SNAPPROGRESS     ((NTSTATUS)0xC000F500L)
...
#define RPC_NTOF_RESOURCES          ((NTSTATUS)0xC0020016L)
...
#define RPC_NT_PROCNUMOF_RANGE      ((NTSTATUS)0xC002002EL)
...
#define RPC_NT_SSNULL_CONTEXT        ((NTSTATUS)0xC0030004L)
...
#define STATUS_CTX_CLIENT_LICENSEUSE ((NTSTATUS)0xC00A0034L)
...
#define STATUS_CLUSTER_JOINPROGRESS  ((NTSTATUS)0xC0130003L)
...
#define STATUS_CLUSTER_JOIN_NOTPROGRESS ((NTSTATUS)0xC013000FL)
...
#define STATUS_CLUSTER_CSV_READ_OPLOCK_BREAKPROGRESS ((NTSTATUS)0xC0130020L)
...
#define STATUS_CLUSTER_CSV_SNAPSHOT_CREATIONPROGRESS ((NTSTATUS)0xC0130025L)
...
#define STATUS_EFS_NOT_ALLOWEDTRANSACTION ((NTSTATUS)0xC019003EL)
...
#define STATUS_CANNOT_EXECUTE_FILETRANSACTION ((NTSTATUS)0xC0190044L)
#define STATUS_TRANSACTIONS_NOT_FROZEN   ((NTSTATUS)0xC0190045L)
#define STATUS_TRANSACTION_FREEZEPROGRESS ((NTSTATUS)0xC0190046L)
#define STATUS_NOT_SNAPSHOT_VOLUME       ((NTSTATUS)0xC0190047L)
#define STATUS_NO_SAVEPOINT_WITH_OPEN_FILES ((NTSTATUS)0xC0190048L)
#define STATUS_SPARSE_NOT_ALLOWEDTRANSACTION ((NTSTATUS)0xC0190049L)
...
#define STATUS_COMPRESSION_NOT_ALLOWEDTRANSACTION ((NTSTATUS)0xC0190056L)
...
#define STATUS_NO_LINK_TRACKINGTRANSACTION ((NTSTATUS)0xC0190059L)
#define STATUS_OPERATION_NOT_SUPPORTEDTRANSACTION ((NTSTATUS)0xC019005AL)
...
#define STATUS_LOG_ARCHIVE_NOTPROGRESS ((NTSTATUS)0xC01A0020L)
#define STATUS_LOG_ARCHIVEPROGRESS   ((NTSTATUS)0xC01A0021L)
...
#define STATUS_LOG_FULL_HANDLERPROGRESS ((NTSTATUS)0xC01A0026L)
...
#define STATUS_GRAPHICS_PINNED_MODE_MUST_REMAINSET ((NTSTATUS)0xC01E0312L)
#define STATUS_GRAPHICS_PATH_ALREADYTOPOLOGY ((NTSTATUS)0xC01E0313L)
#define STATUS_GRAPHICS_MODE_ALREADYMODESET ((NTSTATUS)0xC01E0314L)
...
#define STATUS_GRAPHICS_SOURCE_ALREADYSET ((NTSTATUS)0xC01E0317L)
#define STATUS_GRAPHICS_TARGET_ALREADYSET ((NTSTATUS)0xC01E0318L)
...
#define STATUS_GRAPHICS_FREQUENCYRANGE_NOTSET ((NTSTATUS)0xC01E031DL)
#define STATUS_GRAPHICS_NO_PREFERRED_MODE ((NTSTATUS)0x401E031EL)
#define STATUS_GRAPHICS_FREQUENCYRANGE_ALREADYSET ((NTSTATUS)0xC01E031FL)
...
#define STATUS_GRAPHICS_PATH_NOTTOPOLOGY ((NTSTATUS)0xC01E0327L)
...
#define STATUS_GRAPHICS_MONITORDESCRIPTOR_NOTSET ((NTSTATUS)0xC01E032CL)
#define STATUS_GRAPHICS_MONITORDESCRIPTOR_ALREADYSET ((NTSTATUS)0xC01E032DL)
...
#define STATUS_GRAPHICS_SOURCE_NOTTOPOLOGY ((NTSTATUS)0xC01E0339L)
...
#define STATUS_GRAPHICS_TARGET_NOTTOPOLOGY ((NTSTATUS)0xC01E0340L)
#define STATUS_GRAPHICS_NO_DISPLAY_MODE_MANAGEMENT_SUPPORT ((NTSTATUS)0xC01E0341L)
#define STATUS_GRAPHICS_VIDPN_SOURCEUSE ((NTSTATUS)0xC01E0342L)
...
#define STATUS_GRAPHICS_MODE_NOTMODESET ((NTSTATUS)0xC01E034AL)
#define STATUS_GRAPHICS_DATASET_IS_EMPTY ((NTSTATUS)0x401E034BL)
#define STATUS_GRAPHICS_NO_MORE_ELEMENTSDATASET ((NTSTATUS)0x401E034CL)
...
#define STATUS_GRAPHICS_OPM_ALL_HDCP_HARDWARE_ALREADYUSE ((NTSTATUS)0xC01E0518L)
...
#define STATUS_GRAPHICS_SESSION_TYPE_CHANGEPROGRESS ((NTSTATUS)0xC01E05E8L)
...
#define STATUS_FWPUSE                ((NTSTATUS)0xC022000AL)
#define STATUS_FWP_DYNAMIC_SESSIONPROGRESS ((NTSTATUS)0xC022000BL)
#define STATUS_FWP_WRONG_SESSION         ((NTSTATUS)0xC022000CL)
#define STATUS_FWP_NO_TXNPROGRESS    ((NTSTATUS)0xC022000DL)
#define STATUS_FWP_TXNPROGRESS       ((NTSTATUS)0xC022000EL)
...
#define STATUS_FWPOF_BOUNDS         ((NTSTATUS)0xC0220028L)
...
#define STATUS_NDIS_RESETPROGRESS    ((NTSTATUS)0xC023000DL)
...
#define STATUS_NDIS_GROUP_ADDRESSUSE ((NTSTATUS)0xC023001AL)
...
#define STATUS_NDIS_DOT11_MEDIAUSE   ((NTSTATUS)0xC0232001L)
...
#define STATUS_HV_PROPERTY_VALUEOF_RANGE ((NTSTATUS)0xC035000AL)
...
#define STATUS_HV_OBJECTUSE          ((NTSTATUS)0xC0350019L)
...
#define STATUS_HV_DEVICE_NOTDOMAIN   ((NTSTATUS)0xC0350076L)
...
#define STATUS_VOLMGR_DISK_CONFIGURATION_NOTSYNC ((NTSTATUS)0xC0380003L)
...
#define STATUS_VOLMGR_EXTENT_NOTPUBLIC_REGION ((NTSTATUS)0xC038001CL)
...
#define STATUS_VOLMGR_MEMBERSYNC     ((NTSTATUS)0xC0380023L)
...
#define STATUS_VOLMGR_PLEXSYNC       ((NTSTATUS)0xC0380038L)
...
#define STATUS_VOLMGR_TRANSACTIONPROGRESS ((NTSTATUS)0xC0380043L)
...
#define STATUS_VOLMGR_NUMBER_OF_DISKSPLEX_INVALID ((NTSTATUS)0xC0380054L)
#define STATUS_VOLMGR_NUMBER_OF_DISKSMEMBER_INVALID ((NTSTATUS)0xC0380055L)
...
#define STATUS_VHD_DIFFERENCING_CHAIN_ERRORPARENT ((NTSTATUS)0xC03A0019L)
...
#define STATUS_CLIP_LICENSE_HARDWARE_IDOF_TOLERANCE ((NTSTATUS)0xC0EA0009L)
...
#define STATUS_SPACES_REPAIRPROGRESS ((NTSTATUS)0xC0E70027L)
...
#define STATUS_VSM_DMA_PROTECTION_NOTUSE ((NTSTATUS)0xC0450001L)
...
#define STATUS_IORING_SUBMITPROGRESS ((NTSTATUS)0xC0460006L)
