...
LOUDDK_API_ENTRY ULONGLONG READ_REGISTER_ULONGLONG(PULONGLONG Register);
LOUDDK_API_ENTRY VOID WRITE_REGISTER_ULONGLONG(PULONGLONG Register, ULONGLONG Data);
