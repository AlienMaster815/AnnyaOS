...
typedef void (NTAPI * PFLS_CALLBACK_FUNCTION)(void*);
...
typedef union _ARM64_NT_NEON128
{
    ...
    WORD  H[8];
    BYTE  B[16];
} ARM64_NT_NEON128, *PARM64_NT_NEON128, NEON128, *PNEON128;
...
#ifdef _USER_MODE_CODE_
#define RtlCopyMemory(Destination, Source, Length) LouMemCpy((Destination),(Source),(Length))
#else
...
#else
#define __WINE_ATOMIC_LOAD_ACQUIRE(ptr, ret) __atomic_load(ptr, ret, 1)
#define __WINE_ATOMIC_LOAD_RELAXED(ptr, ret) __atomic_load(ptr, ret, 0)
#define __WINE_ATOMIC_STORE_RELEASE(ptr, val) __atomic_store(ptr, val, 0)
#define __WINE_ATOMIC_STORE_RELAXED(ptr, val) __atomic_store(ptr, val, 0)
...
//TODO: create KULA __fastfail in LouDLL
...
//        KulaPacket[1] = code; 
//        LouCALL(WINECALL_FASTFAIL, (UINT64)&KulaPacket[0], WINECALL);
//    #endif
//}
