...
typedef struct PACKED _SCSI_LOG_SENSE_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_LOG_SENSE 0x4D
    UINT8   Sp;
    UINT8   PageCodePc;
    UINT8   SubPageCode;
    UINT8   Reserved;
...
typedef struct PACKED _SCSI_MODE_SELECT6_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_MODE_SELECT_CDB6 0x15
    UINT8   SpRtdPf;
    UINT16  Reserved;
...
typedef struct PACKED _SCSI_MODE_SELECT10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_MODE_SELECT_CDB10 0x55 
    UINT8   SpPf;
    UINT8   Reserved[5];
    UINT16  ParameterListLength;
    UINT8   Control;
...
typedef struct PACKED _SCSI_PERSISTENT_RESERVE_IN_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_PERSISTENT_RESERVE_IN 0x5E
    UINT8   ServiceAction;
    UINT8   Reservedp[5];
    UINT16  AllocationLength;
    UINT8   Control;
...
typedef struct PACKED _SCSI_READ6_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_READ_CDB6 0x08
    UINT8   Lba[3];
...
typedef struct PACKED _SCSI_READ10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_READ_CDB10 0x28
...
typedef struct PACKED _SCSI_READ12_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_READ_CDB12 0xA8
    UINT8   RarcFuaDpoRdprotect;
    UINT32  Lba;
...
typedef struct PACKED _SCSI_READ16_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_READ_CDB16 0x88
...
typedef struct PACKED _SCSI_READ_BUFFER10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_READ_BUFFER_CDB10 0x3C
...
typedef struct PACKED _SCSI_READ_BUFFER16_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_READ_BUFFER_CDB16 0x9E
    UINT8   ModeModeSpecific;
    UINT64  BufferOffset;
    UINT32  AllocationLength;
    UINT8   BufferId;
...
typedef struct PACKED _SCSI_READ_CAPACITY10_COMMAND_STRUCTUTRE{
    UINT8   OpCode; //SCSI_COMMAND_READ_CAPACITY_CDB10 0x25
    UINT8   Reserved1;
    UINT32  Lba;
    UINT16  Reserved2;
    UINT8   Pmi;
    UINT8   Control;
}SCSI_READ_CAPACITY10_COMMAND_STRUCTURE, * PSCSI_READ_CAPACITY10_COMMAND_STRUCTURE;

typedef struct PACKED _SCSI_READ_CAPACITY16_COMMAND_STRUCTURE{
    UINT8   OpCode;         //SCSI_COMMAND_READ_CAPACITY_CDB16 0x9E
    UINT8   ServiceAction;  //SCSI_SERVICE_ACTION_READ_CAPACITY_CDB16
    UINT64  Lba;
    UINT32  AllocationLength;
    UINT8   Pmi;
    UINT8   Control;
...
typedef struct PACKED _SCSI_READ_DEFECT_DATA10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_READ_DEFECT_DATA_CDB10 0x37
    UINT8   Reserved1;
...
typedef struct PACKED _SCSI_READ_DEFECT_DATA12_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_READ_DEFECT_DATA_CDB12 0xB7
    UINT8   DlfReqGListPList;
    UINT32  Adi;
    UINT32  AllocationLength;
    UINT8   Reserved;
...
typedef struct PACKED _SCSI_READ_LONG10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_READ_LONG_CDB10 0x3E
    UINT8   CorrctPblock;
    UINT32  Lba;
    UINT8   Reserved;
    UINT16  Btl;
...
typedef struct PACKED _SCSI_READ_LONG16_COMMAND_STRUCTURE{
    UINT8   OpCode;         //SCSI_COMMAND_READ_LONG_CDB16 0x9E
    UINT8   ServiceAction;  //SCSI_SERVICE_ACTION_READ_LONG16
    UINT64  Lba;
    UINT16  Reserved;
    UINT16  Btl;
    UINT8   CorrctPblock;
...
typedef struct PACKED _SCSI_REASSIGN_BLOCKS_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_REASIGN_BLOCKS 0x07
    UINT8   LongGListLba;
    UINT8   Reserved[3];
    UINT8   Control;
...
typedef struct PACKED _SCSI_RECIEVE_DIAGNOSTIC_RESULTS_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_RECIEVE_DIAGNOSTIC_RESULTS 0x1C
    UINT8   Pcv;
    UINT8   PageCode;
    UINT16  AllocationLength;
    UINT8   Control;
...
typedef struct PACKED _SCSI_RELEASE10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_RELEASE_CDB10 0x57
...
typedef struct PACKED _SCSI_REPORT_IDENTIFYING_INFORMATION_COMMAND_STRUCUTRE{
    UINT8   OpCode;         //SCSI_COMMAND_REPORT_IDENTIFYING_INFO 0xA3
    UINT8   ServiceAction;  //SCSI_SERVICE_ACTION_IDENTIFYING_INFORMATION
    UINT16  Reserved;
    UINT16  Restricted;
    UINT32  AllocationLength;
    UINT8   InformationType;
    UINT8   Control;
}SCSI_REPORT_IDENTIFYING_INFORMATION_COMMAND_STRUCTURE, * PSCSI_REPORT_IDENTIFYING_INFORMATION_COMMAND_STRUCTURE;

typedef struct PACKED _SCSI_REPORT_LUNS_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_REPORT_LUNS 0xA0
    UINT8   Reserved1;
    UINT8   SelectReport;
    UINT8   Reserved2[3];
    UINT32  AllocationLength;
...
typedef struct PACKED _SCSI_REPORT_SUPPORTED_OPERATION_CODES{
    UINT8   OpCode;         //SCSI_COMMAND_REPORT_SUPPORTED_OPCODES 0xA3
    UINT8   ServiceAction;  //SCSI_SERVICE_ACTION_REPORT_SUPPORTED_OPCODES
...
typedef struct PACKED _SCSI_REPORT_SUPPORTED_TASK_MANAGEMENT_FUNCTIONS_COMMAND_STRUCTURE{
    UINT8   OpCode;         //SCSI_COMMAND_REPORT_SUPPORTED_TASKMNG 0xA3
    UINT8   ServiceAction;  //SCSI_SERVICE_ACTION_REPORT_SUPPORTED_TASKMNG  
    UINT8   Repd;
    UINT8   Reserved1[3];
    UINT32  AllocationLength;
    UINT8   Reserved2;
...
typedef struct PACKED _SCSI_REPORT_TIMESTAMP_COMMAND_STRUCTURE{
    UINT8   OpCode;         //SCSI_COMMAND_REPORT_TIMESTAMP 0xA3
    UINT8   ServiceAction;  //SCSI_SERVICE_ACTION_REPORT_TIMESTAMP
    UINT32  Reserved1;
    UINT32  AllocationLength;
    UINT8   Reserved2;
    UINT8   Control;
...
typedef struct PACKED _SCSI_REQUEST_SENSE_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_REQUEST_SENSE 0x03
    UINT8   Desc;
    UINT16  Reserved;
    UINT8   AllocationLength;
    UINT8   Control;
...
typedef struct PACKED _SCSI_RESERVE6_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_RESERVE_CDB6 0x16
    UINT32  Obsolete;
    UINT8   Control;
}SCSI_RESERVE6_COMMAND_STRUCTURE, * PSCSI_RESERVE6_COMMAND_STRUCTURE;

typedef struct PACKED _SCSI_RESERVE10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_RESERVE_CDB10 0x56
    UINT8   LongId3rdParty;
    UINT8   Obsolete;
    UINT8   ThirdPartyDevID;
    UINT8   Reserved[3];
...
typedef struct PACKED _SCSI_REZERO_UNIT_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_REZERO_UNIT 0x01
    UINT8   LunLbaMSB;
    UINT8   Reserved[3];
    UINT8   Control;
...
typedef struct PACKED _SCSI_SANITIZE_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_SANITIZE 0x48
...
typedef struct PACKED _SCSI_SECURITY_PROTOCOL_IN_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_SECURITY_PROTOCOL_IN 0xA2
...
typedef struct PACKED _SCSI_SECURITY_PROTOCOL_OUT_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_SECURITY_PROTOCOL_OUT 0xB5
    UINT8   SecurityProtocol;
    UINT16  SecurityProtocolSpecific;
    UINT8   Inc512;
    UINT8   Reserved1;
...
typedef struct PACKED _SCSI_SEEK_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_SEEK_CDB6 0x0B
    UINT8   LunLbaMsb;
    UINT16  Lba;
    UINT8   Reserved;
    UINT8   Control;
...
typedef struct PACKED _SCSI_SEEK_EX_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_SEEK_EXTENDED_CDB10 0x2B
    UINT8   Lun;
    UINT32  Lba;
    UINT8   Reserved[3];
    UINT8   Control;
...
typedef struct PACKED _SCSI_SET_IDENTIFYING_INFORMATION_COMMAND_STRUCTURE{
    UINT8   OpCode;         //SCSI_COMMAND_SET_IDENTIFYING_INFO 0xA4
    UINT8   ServiceAction;  //SCSI_SERVICE_ACTION_SET_IDENTIFYING_INFORMATION
    UINT16  Reserved;
    UINT16  Restricted;
    UINT32  ParameterListLength;
    UINT8   InformationType;
...
typedef struct PACKED _SCSI_SET_TIMESTAMP_COMMAND_STRUCTURE{
    UINT8   OpCode;         //SCSI_COMMAND_SET_TIMESTAMP 0xA4
    UINT8   ServiceAction;  //SCSI_SERVICE_ACTION_SET_TIMESTAMP
    UINT32  Reserved1;
    UINT32  ParameterListLength;
    UINT8   Reserved2;
    UINT8   Control;
...
typedef struct PACKED _SCSI_START_STOP_UNIT_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_START_STOP_UNIT 0x1B
    UINT8   Immed;
    UINT8   Reserved;
...
typedef struct PACKED _SCSI_STREAM_CONTROL_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_STREAM_CONTROL 0x9E
    UINT8   ServiceActionStrCtl;
    UINT16  Reserved1;
    UINT16  StrID;
    UINT8   Reserved2[9];
    UINT8   Control;
...
typedef struct PACKED _SCSI_SYNCHRONIZE_CACHE10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_SYNCHRONIZE_CACHE_CDB10
    UINT8   Immed;
    UINT32  Lba;
    UINT8   GroupNumber;
...
typedef struct PACKED _SCSI_SYNCHRONIZE_CACHE16_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_SYNCHRONIZE_CACHE_CDB16 0x91
    UINT8   Immed;
    UINT64  Lba;
...
typedef struct PACKED _SCSI_TEST_UNIT_READY_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_TEST_UNIT_READY 0x00
    UINT32  Reserved;
    UINT8   Control;
...
typedef struct PACKED _SCSI_UNMAP_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_UNMAP 0x42
    UINT8   Anchor;
    UINT32  Reserved;
    UINT8   GroupNumber;
    UINT16  ParameterListLength;
...
typedef struct PACKED _SCSI_VERIFY10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_VERIFY_CDB10 0x2F
...
typedef struct PACKED _SCSI_VERIFY12_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_VERIFY_CDB12 0xAF
    UINT8   BytChkDpoVrProtect;
    UINT32  Lba;
...
typedef struct PACKED _SCSI_VERIFY16_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_VERIFY_CDB16 0x8F
    UINT8   BytChkDpoVrProtect;
    UINT64  Lba;
    UINT32  VerificationLength;
    UINT8   GroupNumber;
...
typedef struct PACKED _SCSI_VERIFY32_COMMAND_STRUCTURE{
    UINT8   OpCode;         //SCSI_COMMAND_VERIFY_CDB32 0x7F
    UINT8   Control;
    UINT32  Reserved1;
    UINT8   GroupNumber;
    UINT8   AdditionalCdbLength;
    UINT16  ServiceAction;  //SCSI_SERVICE_ACTION_VERIFY_CDB32 0x0A
    UINT8   BytChkDpoVrProtect;
    UINT8   Reserved2;
    UINT64  Lba;
    UINT32  EilbrTag;
...
typedef struct PACKED _SCSI_WRITE6_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_CDB6 0x0A
    UINT8   MsbLba;
    UINT16  Lba;
    UINT8   TransferLength;
    UINT8   Control;
...
typedef struct PACKED _SCSI_WRITE10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_CDB10 0x2A
...
typedef struct PACKED _SCSI_WRITE12_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_CDB12 0xAA
    UINT8   FuaDpoWrProtect;
    UINT32  Lba;
    UINT32  TransferLength;
    UINT8   GroupNumber;
...
typedef struct PACKED _SCSI_WRITE16_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_CDB16 0x8A
...
typedef struct PACKED _SCSI_WRITE32_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_CDB32 0x7F
    UINT8   Control;
    UINT32  Reserved1;
    UINT8   GroupNumber;
    UINT8   AdditionalCdbLength;
...
typedef struct PACKED _SCSI_WRITE_AND_VERIFY10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_AND_VERIFY_CDB10 0x2E
...
typedef struct PACKED _SCSI_WRITE_AND_VERIFY12_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_AND_VERIFY_CDB12 0xAE
    UINT8   BytChkDpoWrProtect;
    UINT32  Lba;
    UINT32  TransferLength;
    UINT8   GroupNumber;
...
typedef struct PACKED _SCSI_WRITE_AND_VERIFY16_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_AND_VERIFY_CDB16 0x8E
    UINT8   BytChkDpoWrProtect;
    UINT64  Lba;
    UINT32  TransferLength;
    UINT8   GroupNumber;
    UINT8   Control;
}SCSI_WRITE_AND_VERIFY16_COMMAND_STRUCTURE, * PSCSI_WRITE_AND_VERIFY16_COMMAND_STRUCTURE;

typedef struct PACKED _SCSI_WRITE_AND_VERIFY32_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_AND_VERIFY_CDB32 0x7F
    UINT8   Control;
    UINT32  Reserved1;
    UINT8   GroupNumber;
    UINT8   AdditionalCdbLength;
    ...
    UINT16  LbaTagMask;
    UINT32  TransferLength;
}SCSI_WRITE_AND_VERIFY32_COMMAND_STRUCTURE, * PSCSI_WRITE_AND_VERIFY32_COMMAND_STRUCTURE;

typedef struct PACKED _SCSI_WRITE_ATOMIC16_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_ATOMIC_CDB16 0x9C
    UINT8   FuaDpoWrProtect;
    UINT64  Lba;
...
typedef struct PACKED _SCSI_WRITE_ATOMIC32_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_ATOMIC_CDB32 0x7F
    UINT8   Control;
    UINT16  Reserved1;
    UINT16  AtomicBoundry;
    UINT8   GroupNumber;
...
typedef struct PACKED _SCSI_WRITE_BUFFER_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_BUFFER 0x3B
    UINT8   ModeModeSpecific;
    UINT8   BufferId;
    UINT8   BufferOffset[3];
...
typedef struct PACKED _SCSI_WRITE_LONG10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_LONG 0x3F
    UINT8   WrUncor;
    UINT32  Lba;
    UINT8   Reserved;
    UINT16  TransferLength;
...
typedef struct PACKED _SCSI_WRITE_LONG16_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_LONG_CDB16 0x9F
...
typedef struct PACKED _SCSI_WRITE_SAME10_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_SAME_CDB10 0x41
...
typedef struct PACKED _SCSI_WRITE_SAME16_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_SAME_CDB16 0x93
...
typedef struct PACKED _SCSI_WRITE_SAME32_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_SAME_CDB32 0x7F
    UINT8   Control;
    UINT32  Reserved1;
    UINT8   GroupNumber;
    UINT8   AdditionalCdbLength;
...
typedef struct PACKED _SCSI_WRITE_STREAM16_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_STREAM_CDB16 0x9A
    UINT8   FuaDpoWrProtect;
    UINT64  Lba;
    UINT16  StrID;
    UINT16  TransferLength;
...
typedef struct PACKED _SCSI_WRITE_STREAM32_COMMAND_STRUCTURE{
    UINT8   OpCode; //SCSI_COMMAND_WRITE_STREAM_CDB32 0x7F
    UINT8   Control;
    UINT16  Reserved1;
    UINT16  StrID;
    UINT8   GroupNumber;
...
#define SCSI_SERVICE_ACTION_WRITE_ATOMIC_CDB32          0x000F
#define SCSI_SERVICE_ACTION_WRITE_LONG_CDB16            0x0011
#define SCSI_SERVICE_ACTION_WRITE_SAME_CDB32            0x000D
#define SCSI_SERVICE_ACTION_WRITE_STREAM_CDB32          0x0010
