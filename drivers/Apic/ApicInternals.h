...
typedef struct _INTERRUPT_ROUTE_INSTALLATION_INTERRUPT_PACKET{
    PVOID InstallData;
}INTERRUPT_ROUTE_INSTALLATION_INTERRUPT_PACKET, * PINTERRUPT_ROUTE_INSTALLATION_INTERRUPT_PACKET;

typedef struct _DEMON_INSTALLATION_INTERRUPT_PACKET{
    PVOID InstallData;
}DEMON_INSTALLATION_INTERRUPT_PACKET, * PDEMON_INSTALLATION_INTERRUPT_PACKET;
...
typedef struct _IPI_INTERRUPT_PACKET{
    ...
    union{
        ...
        INTERRUPT_ROUTE_INSTALLATION_INTERRUPT_PACKET   RouteInstallationPacket;
        DEMON_INSTALLATION_INTERRUPT_PACKET             DemonInstallationPacket;
    };
