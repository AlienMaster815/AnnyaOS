...
LOUSTATUS LoUSBInitializeHostController(P_PCI_DEVICE_OBJECT PDEV, PUSB_HOST_CONTROLER_DRIVER HostDriver){
    ...
    HostController = (PUSB_HOST_CONTROLER_DEVICE)LouKeMallocEx(sizeof(USB_HOST_CONTROLER_DEVICE), GET_ALIGNMENT(USB_HOST_CONTROLER_DEVICE), WRITEABLE_PAGE | PRESENT_PAGE);
