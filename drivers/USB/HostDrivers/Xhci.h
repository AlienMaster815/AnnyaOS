...
#define XHCI_DEVICE_CONTEXT_ROUTE_STRING_MASK       0x000FFFFF
#define XHCI_DEVICE_CONTEXT_ROUTE_STRING_SHIFT      0
#define XHCI_DEVICE_CONTEXT_ROUTE_STRING            (XHCI_DEVICE_CONTEXT_ROUTE_STRING_MASK << XHCI_DEVICE_CONTEXT_ROUTE_STRING_SHIFT)
#define XHCI_DEVICE_CONTEXT_SPEED_MASK              0x0F
#define XHCI_DEVICE_CONTEXT_SPEED_SHIFT             20
#define XHCI_DEVICE_CONTEXT_SPEED                   (XHCI_DEVICE_CONTEXT_SPEED_MASK << XHCI_DEVICE_CONTEXT_SPEED_SHIFT)
#define XHCI_DEVICE_CONTEXT_MTT_MASK                1
#define XHCI_DEVICE_CONTEXT_MTT_SHIFT               25
#define XHCI_DEVICE_CONTEXT_MTT                     (XHCI_DEVICE_CONTEXT_MTT_MASK << XHCI_DEVICE_CONTEXT_MTT_SHIFT)
#define XHCI_DEVICE_CONTEXT_HUB_MASK                1
#define XHCI_DEVICE_CONTEXT_HUB_SHIFT               26
#define XHCI_DEVICE_CONTEXT_HUB                     (XHCI_DEVICE_CONTEXT_HUB_MASK << XHCI_DEVICE_CONTEXT_HUB_SHIFT)
#define XHCI_DEVICE_CONTEXT_CONTEXT_ENTRIES_MASK    0x1F
#define XHCI_DEVICE_CONTEXT_CONTEXT_ENTRIES_SHIFT   27
#define XHCI_DEVICE_CONTEXT_CONTEXT_ENTRIES         (XHCI_DEVICE_CONTEXT_CONTEXT_ENTRIES_MASK << XHCI_DEVICE_CONTEXT_CONTEXT_ENTRIES_SHIFT)
//Page 445
