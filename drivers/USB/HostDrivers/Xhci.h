...
#define XHCI_MMIO_REGISTERS_BAR     0
#define XHCI_MMIO_REGISTERS_OFFSET  0
...
#define XHCI_GET_DOORBELL_REGISTERS(Cap)        (PXHCI_DOORBELL_REGISTERS)((UINTPTR)Cap + Cap->DoorbellOffset)
...
#define XHCI_GET_RUNTIME_REGISTERS(Cap)         (PXHCI_RUNTIME_REGISTERS)((UINTPTR)Cap + Cap->RuntimeRegOfffset)
...
//Latency Tolerence Value
typedef struct PACKED _XHCI_LTV_COMMAND_TRB{
    UINT32 DWord[4];
}XHCI_LTV_COMMAND_TRB, * PXHCI_LTV_COMMAND_TRB;

//offset 12
#define XHCI_LTV_COMMAND_TRB_CYCLE_BIT_MASK                         1
#define XHCI_LTV_COMMAND_TRB_CYCLE_BIT_SHIFT                        0
#define XHCI_LTV_COMMAND_TRB_CYCLE_BIT                              (XHCI_LTV_COMMAND_TRB_CYCLE_BIT_MASK << XHCI_LTV_COMMAND_TRB_CYCLE_BIT_SHIFT)
#define XHCI_LTV_COMMAND_TRB_TYPE_MASK                              0x3F
#define XHCI_LTV_COMMAND_TRB_TYPE_SHIFT                             10
#define XHCI_LTV_COMMAND_TRB_TYPE                                   (XHCI_LTV_COMMAND_TRB_TYPE_MASK << XHCI_LTV_COMMAND_TRB_TYPE_SHIFT)
#define XHCI_LTV_COMMAND_TRB_BEST_EFFORT_LTV_MASK                   0x0FFF
#define XHCI_LTV_COMMAND_TRB_BEST_EFFORT_LTV_SHIFT                  16
#define XHCI_LTV_COMMAND_TRB_BEST_EFFORT_LTV                        (XHCI_LTV_COMMAND_TRB_BEST_EFFORT_LTV_MASK << XHCI_LTV_COMMAND_TRB_BEST_EFFORT_LTV_SHIFT)

typedef struct PACKED _XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB{
    UINT32  DWord[4];
}XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB, * PXHCI_GET_PORT_BANDWIDTH_COMMAND_TRB;

//offset 0
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_LO_MASK                 0x0FFFFFFF
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_LO_SHIFT                4
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_LO                      (XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_LO_MASK << XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_LO_SHIFT)

//offset 4
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_HI_MASK                 UINT32_MAX
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_HI_SHIFT                0
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_HI                      (XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_HI_MASK << XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_HI_SHIFT)

//offset 12
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_CYCLE_BIT_MASK          1
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_CYCLE_BIT_SHIFT         0
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_CYCLE_BIT               (XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_CYCLE_BIT_MASK << XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_CYCLE_BIT_SHIFT)
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_TYPE_MASK               0x3F
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_TYPE_SHIFT              10
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_TYPE                    (XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_TYPE_MASK << XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_TYPE_SHIFT)
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_DEV_SPEED_MASK          0x0F
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_DEV_SPEED_SHIFT         16
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_DEV_SPEED               (XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_DEV_SPEED_MASK << XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_DEV_SPEED_SHIFT)
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_HUB_SLOT_ID_MASK        0xFF
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_HUB_SLOT_ID_SHIFT       24
#define XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_HUB_SLOT_ID             (XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_HUB_SLOT_ID << XHCI_GET_PORT_BANDWIDTH_COMMAND_TRB_HUB_SLOT_ID_SHIFT)

typedef struct _XHCI_FORCE_HEADER_COMMAND_TRB{
    UINT32  DWord[4];
}XHCI_FORCE_HEADER_COMMAND_TRB, * PXHCI_FORCE_HEADER_COMMAND_TRB;

//offset 0
#define XHCI_FORCE_HEADER_COMMAND_TRB_PACKET_TYPE_MASK              0x0F
#define XHCI_FORCE_HEADER_COMMAND_TRB_PACKET_TYPE_SHIFT             0
#define XHCI_FORCE_HEADER_COMMAND_TRB_PACKET_TYPE                   (XHCI_FORCE_HEADER_COMMAND_TRB_PACKET_TYPE_MASK << XHCI_FORCE_HEADER_COMMAND_TRB_PACKET_TYPE_SHIFT) 
#define XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_LO_MASK           0x0FFFFFFF
#define XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_LO_SHIFT          4
#define XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO                   (XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_MASK << XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_LO_SHIFT)

//offset 4
#define XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_MID_MASK          UINT32_MAX
#define XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_MID_SHIFT         0
#define XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_MID               (XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_MID_MASK << XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_MID_SHIFT)

//offset 8
#define XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_HI_MASK           UINT32_MAX
#define XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_HI_SHIFT          0
#define XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_HI                (XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_HI_MASK << XHCI_FORCE_HEADER_COMMAND_TRB_HEADER_INFO_HI_SHIFT)

//offset 12
#define XHCI_FORCE_HEADER_COMMAND_TRB_CYCLE_BIT_MASK                1
#define XHCI_FORCE_HEADER_COMMAND_TRB_CYCLE_BIT_SHIFT               0
#define XHCI_FORCE_HEADER_COMMAND_TRB_CYCLE_BIT                     (XHCI_FORCE_HEADER_COMMAND_TRB_CYCLE_BIT_MASK << XHCI_FORCE_HEADER_COMMAND_TRB_CYCLE_BIT_SHIFT)
#define XHCI_FORCE_HEADER_COMMAND_TRB_TYPE_MASK                     0x3F
#define XHCI_FORCE_HEADER_COMMAND_TRB_TYPE_SHIFT                    10
#define XHCI_FORCE_HEADER_COMMAND_TRB_TYPE                          (XHCI_FORCE_HEADER_COMMAND_TRB_TYPE_MASK << XHCI_FORCE_HEADER_COMMAND_TRB_TYPE_SHIFT)
#define XHCI_FORCE_HEADER_COMMAND_TRB_ROOTHUB_PORT_NUM_MASK         0xFF
#define XHCI_FORCE_HEADER_COMMAND_TRB_ROOTHUB_PORT_NUM_SHIFT        24
#define XHCI_FORCE_HEADER_COMMAND_TRB_ROOTHUB_PORT_NUM              (XHCI_FORCE_HEADER_COMMAND_TRB_ROOTHUB_PORT_NUM_MASK << XHCI_FORCE_HEADER_COMMAND_TRB_ROOTHUB_PORT_NUM_SHIFT)

typedef struct PACKED _XHCI_GET_EXT_PROPERTY_COMMAND_TRB{
    UINT32  DWord[4];
}XHCI_GET_EXT_PROPERTY_COMMAND_TRB, * PXHCI_GET_EXT_PROPERTY_COMMAND_TRB;

//offset 0
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_LO_MASK                   0x0FFFFFFF
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_LO_SHIFT                  4
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_LO                        (XHCI_GET_EXT_PROPERTY_COMMAND_TRB_LO_MASK << XHCI_GET_EXT_PROPERTY_COMMAND_TRB_LO_SHIFT)
  
//offset 4
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_HI_MASK                   UINT32_MAX
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_HI_SHIFT                  0
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_HI                        (XHCI_GET_EXT_PROPERTY_COMMAND_TRB_HI_MASK << XHCI_GET_EXT_PROPERTY_COMMAND_TRB_HI_SHIFT)

//offset 8
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_ECI_MASK                  0xFFFF
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_ECI_SHIFT                 0
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_ECI                       (XHIC_GET_EXT_PROPERTY_COMMAND_TRB_ECI_MASK << XHIC_GET_EXT_PROPERTY_COMMAND_TRB_ECI_SHIFT)

//offset 12
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_CYCLE_BIT_MASK            1                 
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_CYCLE_BIT_SHIFT           0
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_CYCLE_BIT                 (XHCI_GET_EXT_PROPERTY_COMMAND_TRB_CYCLE_BIT_MASK << XHCI_GET_EXT_PROPERTY_COMMAND_TRB_CYCLE_BIT_SHIFT)
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_TYPE_MASK                 0x3F
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_TYPE_SHIFT                10
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_TYPE                      (XHCI_GET_EXT_PROPERTY_COMMAND_TRB_TYPE_MASK << XHCI_GET_EXT_PROPERTY_COMMAND_TRB_TYPE_SHIFT)
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_COMMAND_SUB_TYPE_MASK     0x07
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_COMMAND_SUB_TYPE_SHIFT    16
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_COMMAND_SUB_TYPE          (XHCI_GET_EXT_PROPERTY_COMMAND_TRB_COMMAND_SUB_TYPE_MASK << XHCI_GET_EXT_PROPERTY_COMMAND_TRB_COMMAND_SUB_TYPE_SHIFT)
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_ENDPOINT_ID_MASK          0x1F
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_ENDPOINT_ID_SHIFT         19
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_ENDPOINT_ID               (XHCI_GET_EXT_PROPERTY_COMMAND_TRB_ENDPOINT_ID_MASK << XHCI_GET_EXT_PROPERTY_COMMAND_TRB_ENDPOINT_ID_SHIFT)
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_SLOT_ID_MASK              0xFF
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_SLOT_ID_SHIFT             24
#define XHCI_GET_EXT_PROPERTY_COMMAND_TRB_SLOT_ID                   (XHCI_GET_EXT_PROPERTY_COMMAND_TRB_SLOT_ID_MASK << XHCI_GET_EXT_PROPERTY_COMMAND_TRB_SLOT_ID_SHIFT)

typedef struct PACKED _XHCI_SET_EXT_PROPERTY_COMMAND_TRB{
    UINT32  DWord[4];
}XHCI_SET_EXT_PROPERTY_COMMAND_TRB, * PXHCI_SET_EXT_PROPERTY_COMMAND_TRB;

//offset 8
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_ECI_MASK                  0xFFFF
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_ECI_SHIFT                 0
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_ECI                       (XHCI_SET_EXT_PROPERTY_COMMAND_TRB_ECI_MASK << XHCI_SET_EXT_PROPERTY_COMMAND_TRB_ECI_SHIFT)
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_CAPABILITY_PTR_MASK       0x01FF
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_CAPABILITY_PTR_SHIFT      15
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_CAPABILITY_PTR            (XHCI_SET_EXT_PROPERTY_CAPABILITY_PTR_MASK << XHCI_SET_EXT_PROPERTY_CAPABILITY_PTR_SHIFT)

//offset 12
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_CYCLE_BIT_MASK            1
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_CYCLE_BIT_SHIFT           0
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_CYCLE_BIT                 (XHCI_SET_EXT_PROPERTY_COMMAND_TRB_CYCLE_BIT_MASK << XHCI_SET_EXT_PROPERTY_COMMAND_TRB_CYCLE_BIT_SHIFT)
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_TYPE_MASK                 0x3F
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_TYPE_SHIFT                10
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_TYPE                      (XHCI_SET_EXT_PROPERTY_COMMAND_TRB_TYPE_MASK << XHCI_SET_EXT_PROPERTY_COMMAND_TRB_TYPE_SHIFT)
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_COMMAND_SUBTYPE_MASK      0x07
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_COMMAND_SUBTYPE_SHIFT     16
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_COMMAND_SUBTYPE           (XHCI_SET_EXT_PROPERTY_COMMAND_TRB_COMMAND_SUBTYPE_MASK << XHCI_SET_EXT_PROPERTY_COMMAND_TRB_COMMAND_SUBTYPE_SHIFT)
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_ENDPOINT_ID_MASK          0x1F        
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_ENDPOINT_ID_SHIFT         19
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_ENDPOINT_ID               (XHCI_SET_EXT_PROPERTY_COMMAND_TRB_ENDPOINT_ID_MASK << XHCI_SET_EXT_PROPERTY_COMMAND_TRB_ENDPOINT_ID_SHIFT)
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_SLOT_ID_MASK              0xFF
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_SLOT_ID_SHIFT             24
#define XHCI_SET_EXT_PROPERTY_COMMAND_TRB_SLOT_ID                   (XHCI_SET_EXT_PROPERTY_COMMAND_TRB_SLOT_ID_MASK << XHCI_SET_EXT_PROPERTY_COMMAND_TRB_SLOT_ID_SHIFT)
...
typedef struct _XHCI_DEVICE_OBJECT_CAPABILITIES{
    UINT16                          Version;
    UINT8                           MaxSlots;
    ...
    BOOLEAN                         PortPowerControlSupport;
    BOOLEAN                         PortIndicatorSupport;
    BOOLEAN                         LightHCResetSupport;
    BOOLEAN                         LtcSupport;
    BOOLEAN                         NssSupport;
    BOOLEAN                         PaeSupport;
    BOOLEAN                         SpcSupport;
...
typedef struct _XHCI_DEVICE{
    ...
    PXHCI_CAPABILITIES_REGISTER     CapRegisters;
