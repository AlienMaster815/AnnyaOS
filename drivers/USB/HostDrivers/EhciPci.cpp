...
LOUSTATUS AddDevice(
    ...
    PciHalMapPciResource(PDEV, EHCI_OPERATIONAL_REGISTER_BAR, PCI_IOMAP_FLAGS_DEFAULT_MAPPING);

    PEHCI_CAPABILITY_REGISTERS CapRegs = (PEHCI_CAPABILITY_REGISTERS)PciHalGetIoRegion(PDEV, EHCI_OPERATIONAL_REGISTER_BAR, EHCI_CAP_REGISTER_OFFSET);
