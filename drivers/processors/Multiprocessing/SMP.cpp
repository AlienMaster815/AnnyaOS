...
KERNEL_IMPORT EventHandle LouKeInitiateStartSmpEvent(uint8_t SmpId);
KERNEL_IMPORT void LouKeFinishStartSmpEvent(uint8_t SmpId);
KERNEL_IMPORT void LouKeWaitForSmpEventToFinish(EventHandle Event);
