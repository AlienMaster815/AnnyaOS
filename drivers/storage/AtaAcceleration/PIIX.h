...
#define PRIMARY_BMICOM_REGISTER(x)          (((PPIIX_HOST_PRIVATE_DATA)x)->Bmiba + PRIMARY_BMICOM_REGISTER_OFFSET)
#define SECONDARY_BMICOM_REGISTER_OFFSET    0x08
#define SECONDARY_BMICOM_REGISTER(x)        (((PPIIX_HOST_PRIVATE_DATA)x)->Bmiba + SECONDARY_BMICOM_REGISTER_OFFSET)
...
#define PRIMARY_BMISTA_REGISTER(x)          (((PPIIX_HOST_PRIVATE_DATA)x)->Bmiba + PRIMARY_BMISTA_REGISTER_OFFSET)
#define SECONDARY_BMISTA_REGISTER_OFFSET    0x0A
#define SECONDARY_BMISTA_REGISTER(x)        (((PPIIX_HOST_PRIVATE_DATA)x)->Bmiba + SECONDARY_BMISTA_REGISTER_OFFSET)
...
#define PRIMARY_BMIDTP_REGISTER(x)          (((PPIIX_HOST_PRIVATE_DATA)x)->Bmiba + PRIMARY_BMIDTP_REGISTER_OFFSET)
#define SECONDARY_BMIDTP_REGISTER_OFFSET    0x0C
#define SECONDARY_BMIDTP_REGISTER(x)        (((PPIIX_HOST_PRIVATE_DATA)x)->Bmiba + SECONDARY_BMIDTP_REGISTER_OFFSET)
