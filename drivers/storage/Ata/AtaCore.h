...
ATA_DEVICE_COMMAND_STATUS AtaCoreCheckGetIdleDeviceStatus(PATA_COMMAND_IDLE_STRUCTURE Sts);
ATA_DEVICE_COMMAND_STATUS AtaCoreCheckGetIdleImemdiateDeviceStatus(PATA_COMMAND_IDLE_IMMEDIATE_STRUCTURE Sts);
