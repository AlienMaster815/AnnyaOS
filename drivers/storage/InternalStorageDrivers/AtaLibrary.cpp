...
LouKeMallocAtaDevice(PPCI_DEVICE_OBJECT PDEV, uint8_t PortCount){
    ...
    NewHost = (PLOUSINE_KERNEL_DEVICE_ATA_HOST)LouKeMallocEx(GetStructureSize(LOUSINE_KERNEL_DEVICE_ATA_HOST, Ports, PortCount), GET_ALIGNMENT(LOUSINE_KERNEL_DEVICE_ATA_HOST), KERNEL_GENERIC_MEMORY);
    NewHost->PDEV = PDEV;
