...
PLOUSINE_KERNEL_FILESYSTEM FatFileSystemScan(uint8_t PortID){
    ...
    switch(FinalVerdict){
    case FAT32:{
        PLOUSINE_KERNEL_FILESYSTEM NewFat32System = (PLOUSINE_KERNEL_FILESYSTEM)LouMallocEx(sizeof(LOUSINE_KERNEL_FILESYSTEM), GET_ALIGNMENT(LOUSINE_KERNEL_FILESYSTEM));
    ...
    case FAT12:{
        PLOUSINE_KERNEL_FILESYSTEM NewFat12System = (PLOUSINE_KERNEL_FILESYSTEM)LouMallocEx(sizeof(LOUSINE_KERNEL_FILESYSTEM), GET_ALIGNMENT(LOUSINE_KERNEL_FILESYSTEM));
    ...
    case FAT16:{
        PLOUSINE_KERNEL_FILESYSTEM NewFat16System = (PLOUSINE_KERNEL_FILESYSTEM)LouMallocEx(sizeof(LOUSINE_KERNEL_FILESYSTEM), GET_ALIGNMENT(LOUSINE_KERNEL_FILESYSTEM));
    ...
    case FAT32_EXT:{
        PLOUSINE_KERNEL_FILESYSTEM NewFat32ExtSystem = (PLOUSINE_KERNEL_FILESYSTEM)LouMallocEx(sizeof(LOUSINE_KERNEL_FILESYSTEM), GET_ALIGNMENT(LOUSINE_KERNEL_FILESYSTEM));
...
LOUSTATUS FatDriverEntry(){
    PLOUSINE_KERNEL_FILESYSTEM FatFileSystem = (PLOUSINE_KERNEL_FILESYSTEM)LouMallocEx(sizeof(LOUSINE_KERNEL_FILESYSTEM), GET_ALIGNMENT(LOUSINE_KERNEL_FILESYSTEM));
